...
public class ElasticSearchSinkConstants {
  ...
  */
  ...
  //public static final String DEFAULT_CATEGORY_REGEX = "(.*)";
  //public static final String DEFAULT_CATEGORY_FIELDS = "body";

  public static final String TIME_ZONE = "timeZone";
  public static final String INDEX_NAME_DATE_FORMAT = "dateFormat";
